...
export default caseStudy({
  ...
  entries: [
    ...
    entry({
      ...
      text:       paragraph(`
        Facebook purchases Instagram for $1 billion, placing the platform's design,
    ...
    entry({
      ...
      text:       paragraph(`
        ...
        Another study of 11,876 children similarly found that increases in social media use during early adolescence
        predicted greater depressive symptoms one year later.
      `),
      sources: [
    ...
    entry({
      ...
      text:       paragraph(`
        ...
        To make room for this content, Facebook reduced the visibility of posts from news organizations and public pages.
    ...
    entry({
      ...
      text:       paragraph(`
        ...
        to give NIH tens of millions of dollars to study how social media and other digital media affect childhood cognitive, physical, 
    ...
    entry({
      ...
      text:       paragraph(`
        ...
        reversal after public criticism. Meta framed it as time to work with
    ...
    entry({
      ...
      text:       paragraph(`
        Senators Markey and Blumenthal reintroduce the KIDS Act (Kids Internet Design and Safety Act). The bill would ban manipulative design features for
    ...
    entry({
      ...
      text:       paragraph(`
        ...
        their data safe. 73% do not trust Meta. The company ranks last among major consumer
    ...
    entry({
      ...
      text:       paragraph(`
        Meta and the Stanford Deliberative Democracy Lab release report from the Meta
        Community Forum, a structured global Deliberative Poll on bullying
        and harassment online. 6,300+ people from 32 countries in 23 languages, described as
        the largest deliberative exercise ever conducted. Participants indicated wanting 
    ...
    entry({
      ...
      text:       paragraph(`
        ...
        want developers to build chatbots with transparency and control features. Results are
        publicly released.
      `),
      sources: [
    ...
    entry({
      ...
      actors: 'FTC',
      text:       paragraph(`
        The FTC proposed amendments to the Children’s Online Privacy Protection Rule (COPPA) and opened a 60-day public comment window,
    ...
    entry({
      ...
      actors: 'Senate',
      text:       paragraph(`
        Senate voted 91–3 to pass the Kids Online Safety Act (KOSA).  
        It was the first major federal tech regulation to advance in the Senate since 1998, w
    ...
    entry({
      ...
      text:       paragraph(`
        ...
        Safety Institute, then cited those same groups as independent third-party
